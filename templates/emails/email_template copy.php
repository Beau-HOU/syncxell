...
<head>
  ...
  <meta name="description" content="Confirmation de votre rendez-vous avec notre agence d'immigration au Canada.">

  <title>Confirmation de votre rendez-vous - <?= params('app_short_name') ?></title>
</head>
<body style="margin:0; padding:0; background-color:#f6f9fc; font-family:Arial, sans-serif;">

  <!-- Preheader -->
  <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
    Votre rendez-vous avec notre agence d'immigration a été confirmé éo.
  </div>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:6px; overflow:hidden; box-shadow:0 0 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:10px; text-align:center; background:#ffffff;">
             <a href="<?= params('app_url') ?>"> <img src="<?= asset('img/logo/logo.png') ?>" alt="Logo de <?= params('app_short_name') ?>" width="160" height="auto" style="display:block; margin:0 auto;">
             </a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:10px 30px; color:#111111; text-align:center;">
              <h2 style="margin:0; font-size:24px; font-weight:bold; color:#dc3545;">
                Rendez-vous confirmé avec <?= params('app_short_name') ?>
              </h2>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:0 30px 20px; color:#333333; font-size:15px; line-height:1.6;">
              ...
              Merci d'avoir pris rendez-vous avec notre agence d'immigration au Canada.  
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size:15px; line-height:1.6; color:#333;">
                <tr>
                  <td width="45%" style="padding:4px 0;"><strong style="color:#dc3545;">éY'é Nom & Prénom :</strong></td>
                  <td>{{ nom_complet }}</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">éY"z Numéro de téléphone :</strong></td>
                  <td>{{ telephone_client }}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">éYZé Objet du rendez-vous :</strong></td>
                  <td>{{ service }}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">éY". Date & Heure :</strong></td>
                  <td>{{ date_rdv }}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">. Lieu choisi :</strong></td>
                  <td>{{ lieu }}</td>
                </tr>
              </table>

              <br>
              Notre consultant vous contactera pour confirmation et pour vous informer des informations supplémentaires si nécessaire.  
              <br><br>
              Nous sommes impatients de vous accompagner dans votre projet d'immigration.
            </td>
          </tr>
