...
<head>
    ...
    <title>Résultats de votre évaluation - <?= params('app_short_name') ?></title>
</head>

<body style="margin:0; padding:0; background-color:#f6f9fc; font-family:Arial, sans-serif;">

    <div style="display:none; opacity:0; height:0; overflow:hidden;">
        Les résultats de votre évaluation de profil sont disponibles.
    </div>
                ...
                <table width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:6px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:10px 30px; text-align:center;">
                            <h2 style="margin:0; font-size:22px; font-weight:bold; color:#28a745;">Résultats de votre évaluation</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 30px 20px; color:#333; font-size:15px; line-height:1.6;">
                            ...
                            Nous avons le plaisir de vous informer que votre <b>demande d'évaluation de profil</b> a été traitée par notre équipe.<br><br>

                            <?php if (!empty($payload['report'] ?? '')): ?>
                                <b>Rapport de notre équipe :</b><br>
                                <div style="background:#f8f9fa; border-left:4px solid #dc3545; padding:12px 16px; margin:12px 0; border-radius:0 4px 4px 0; font-size:14px; color:#444; white-space:pre-line;">
                                    <?= nl2br(htmlspecialchars((string)$payload['report'])) ?>
                                </div>
                                <br>
                            <?php endif; ?>

                            <?php if (!empty($payload['has_file'] ?? false)): ?>
                                Vous trouverez en pièce jointe le document détaillé de votre évaluation.<br><br>
                            <?php endif; ?>

                            Pour toute question ou information complémentaire, n'hésitez pas à nous contacter directement.<br><br>
