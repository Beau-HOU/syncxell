...
Salut M/Mme <?=  $user['firstname'] ?> <,<br>
Voici votre code OTP pour accéder à votre espace utilisateur sur 
<b><?= params('app_short_name') ?></b>.<br>Ce code est valide pendant 1 minute.

<div class="otp-container">
    <p style="margin:0; font-size:16px; color:#333;">Votre code OTP est :</p>
    <p class="otp-code"><?= $otp ?></p>
</div> <br>


éséï¸ Ne partagez jamais ce code avec quelqu'un.
