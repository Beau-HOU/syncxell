...
<head>
  ...
  <meta name="description" content="Votre rendez-vous a été modifié par notre consultant.">

  <title>Rendez-vous modifié - <?= params('app_short_name') ?></title>
</head>
<body style="margin:0; padding:0; background-color:#f6f9fc; font-family:Arial, sans-serif;">

  <!-- Preheader -->
  <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
    Votre rendez-vous a été modifié par votre consultant.
  </div>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:6px; overflow:hidden; box-shadow:0 0 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:0 30px 20px; color:#333333; font-size:15px; line-height:1.6;">
              ...
              Nous vous informons que votre rendez-vous avec notre agence a été <strong>modifié</strong> par votre consultant.  
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size:15px; line-height:1.6; color:#333;">
                ...
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">Nouvelle date & heure :</strong></td>
                  <td>{{ date_rdv }}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">Nouveau lieu :</strong></td>
                  <td>{{ lieu }}</td>
                </tr>
                <tr>
              ...
              <br>
              Merci de bien vouloir prendre en compte ces changements.  
              Si la nouvelle date ou le lieu ne vous conviennent pas, veuillez contacter votre consultant pour convenir d'un autre créneau.
              <br><br>
