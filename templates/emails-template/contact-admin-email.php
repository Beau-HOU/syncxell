...
<head>
  ...
  <meta name="description" content="Nouvelle demande de contact reçue.">

  <title>Nouveau contact sur votre site <?= params('app_short_name') ?></title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:6px; overflow:hidden; box-shadow:0 0 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:0 30px 20px; color:#333333; font-size:15px; line-height:1.6;">
              ...
              Vous avez reçu un nouveau message via le formulaire de contact sur votre site <?= params('app_short_name') ?>.  
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size:15px; line-height:1.6; color:#333;">
                ...
                <tr>
                  ...
                  <td>{{ telephone_expediteur }}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">Sujet :</strong></td>
                  <td>{{ sujet_message }}</td>
                </tr>
                <tr>
                  <td style="padding:4px 0;"><strong style="color:#dc3545;">Message :</strong></td>
                  <td>{{ contenu_message }}</td>
                </tr>
              </table>

              <br>
              Merci de traiter ce message et de répondre à l'expéditeur si nécessaire.
            </td>
          </tr>
