...
<head>
  ...
  <meta name="description" content="Votre rendez-vous a été clôturé par notre consultant.">

  <title>Rendez-vous clôturé - <?= params('app_short_name') ?></title>
</head>
<body style="margin:0; padding:0; background-color:#f6f9fc; font-family:Arial, sans-serif;">

  <!-- Preheader -->
  <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
    Votre rendez-vous avec notre consultant a été clôturé.
  </div>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:6px; overflow:hidden; box-shadow:0 0 10px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding:0 30px 20px; color:#333333; font-size:15px; line-height:1.6;">
              ...
              Votre rendez-vous avec notre consultant a été <strong>clôturé</strong>.  
              Voici les détails du rendez-vous que vous avez suivi :
              <br><br>
              ...
              <br>
              Nous vous remercions pour votre confiance et restons disponibles pour toute question ou suivi concernant votre projet d'immigration.
              <br><br>
              É bientôt,<br>
