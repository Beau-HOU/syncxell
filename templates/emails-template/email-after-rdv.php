...
<head>
    <meta charset="utf-8" />
    <title>Email de confirmation de RDV avec <?= getProjetName() ?></title>
...
<body>
    <table class="container" width="700">
        ...
        <tr>
            <td>
                <div class="content">
                    <h3>RDV avec <?= getProjetName() ?></h3>
                    <h2>Salut <?= $name ?>,</h2>
                    <strong>Vous venez de réserver un rendez-vous avec nos agents.</strong>
                    <p>

                        <strong>Informations sur le rendez-vous</strong>
                        <strong>Nom et Prénoms(s) : </strong> <?= $name ?><br><br>
                        <strong>Email : </strong> <?= $email ?><br><br>

                        <strong>Sujet : </strong> <?= $subject ?><br><br>

                        <strong>Date : </strong> <?= formatDateInFr($date) ?><br><br>

                         <strong>Lieu : </strong> <?php if($lieuReunion =="Sur site"): ?> Dans nos locaux <?php else:?> En ligne via : <?= $lieuReunion ?>  <?php endif;?>  <br><br>

                    </p>
                    
                    <p>
                        Merci d'avoir choisi <?= getProjetName() ?>
                        L'Equipe <?= getProjetName() ?>
                    </p>
